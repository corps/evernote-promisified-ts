...
var Promise:PromiseConstructorLike = global.Promise as any;
...
function evernoteDeferredCallback<R>() {
  var reject = null as (e:any)=>void;
  var resolve = null as (v:R)=>void;
  var promise = new Promise<R>((_resolve, _reject) => {
    resolve = _resolve;
    reject = _reject;
  });
  return {
